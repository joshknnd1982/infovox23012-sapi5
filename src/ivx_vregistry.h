...
//
// The Infovox 230 v1.12 engine reads every piece of its configuration -- where
// its rule files live, and the whole voice table -- from
// HKEY_LOCAL_MACHINE\Software\Telia Promotor\Infovox 230\1.1. Historically the
// only ways to satisfy that were to write those keys into the machine's
// registry and leave them there -- which needs an administrator, every time --
// or to redirect a predefined key for the process with RegOverridePredefKey and
// a hive file.
//
