...
constexpr wchar_t kPipePrefix[] = L"\\\\.\\pipe\\Infovox23012TTS_";
constexpr wchar_t kServerMutexPrefix[] = L"Local\\Infovox23012TTS_Server_";
constexpr wchar_t kLaunchMutexPrefix[] = L"Local\\Infovox23012TTS_Launch_";
